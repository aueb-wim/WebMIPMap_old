...
public class InstanceTreeCreator {
    ...
    public InstanceTreeCreator(INode instanceRoot, boolean source, MappingTask mappingTask) {
        ////initComponents();
        ////executeInjection();
        if (mappingTask == null) {
            return;
    ...
    private void creaAlbero(INode instanceRoot, boolean source, MappingTask mappingTask) {
        ...
        treeString = treeCreator.buildInstanceTreeString(instanceRoot, dataSource);
